...
export const DashboardSeptember = () => {
  ...
  const [transactions, setTransactions] = useState({
    entries: JSON.parse(localStorage.getItem("entriesSeptember")) || [],
    exits: JSON.parse(localStorage.getItem("exitsSeptember")) || [],
  });
  ...
  const resetTransactions = () => {
    ...
    localStorage.removeItem("entriesSeptember");
    localStorage.removeItem("exitsSeptember");
  ...
  useEffect(() => {
    ...
    localStorage.setItem("exitsSeptember", JSON.stringify(transactions.exits));
  }, [transactions]);
