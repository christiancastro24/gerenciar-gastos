...
export const DashboardAugust = () => {
  ...
  const [transactions, setTransactions] = useState({
    entries: JSON.parse(localStorage.getItem("entriesAugust")) || [],
    exits: JSON.parse(localStorage.getItem("exitsAugust")) || [],
  });
  ...
  const resetTransactions = () => {
    ...
    localStorage.removeItem("entriesAugust");
    localStorage.removeItem("exitsAugust");
    toast.success("All transactions removed!");
    setTimeout(() => window.location.reload(), 1000);
  };

  useEffect(() => {
    localStorage.setItem("entriesAugust", JSON.stringify(transactions.entries));
    localStorage.setItem("exitsAugust", JSON.stringify(transactions.exits));
  }, [transactions]);
