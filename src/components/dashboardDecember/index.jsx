...
export const DashboardDecember = () => {
  ...
  const [transactions, setTransactions] = useState({
    entries: JSON.parse(localStorage.getItem("entriesDecember")) || [],
    exits: JSON.parse(localStorage.getItem("exitsDecember")) || [],
  });
  ...
  const resetTransactions = () => {
    ...
    localStorage.removeItem("entriesDecember");
    localStorage.removeItem("exitsDecember");
  ...
  useEffect(() => {
    ...
    localStorage.setItem("exitsDecember", JSON.stringify(transactions.exits));
  }, [transactions]);
