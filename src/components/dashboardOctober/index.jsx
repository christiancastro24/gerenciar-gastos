...
export const DashboardOctober = () => {
    ...
    const enviarValorEntrada = () => {
      setIndex(index + 1)
      setEntradas([...entradasOctober,  {id: index, titulo: titulo, valor: valor, categoria: categoria, tipo: 'Entrada'}])
    ...
    const enviarValorSaida = () => {
      setIndex(index + 1)
      setSaidas([...saidasOctober,  {id: index, titulo: titulo, valor: valor, categoria: categoria, tipo: 'Saída'}])
