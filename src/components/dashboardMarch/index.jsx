...
export const DashboardMarch = () => {
  ...
  const [transactions, setTransactions] = useState({
    entries: JSON.parse(localStorage.getItem("entriesMarch")) || [],
    exits: JSON.parse(localStorage.getItem("exitsMarch")) || [],
  });
  ...
  const resetTransactions = () => {
    ...
    localStorage.removeItem("entriesMarch");
    localStorage.removeItem("exitsMarch");
    toast.success("All transactions removed!");
    setTimeout(() => window.location.reload(), 1000);
  };

  useEffect(() => {
    localStorage.setItem("entriesMarch", JSON.stringify(transactions.entries));
    localStorage.setItem("exitsMarch", JSON.stringify(transactions.exits));
  }, [transactions]);
