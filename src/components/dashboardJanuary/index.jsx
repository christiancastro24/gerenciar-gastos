...
export const DashboardJanuary = () => {
  ...
  const [transactions, setTransactions] = useState({
    entries: JSON.parse(localStorage.getItem("entriesJanuary")) || [],
    exits: JSON.parse(localStorage.getItem("exitsJanuary")) || [],
  });
  ...
  const resetTransactions = () => {
    ...
    localStorage.removeItem("entriesJanuary");
    localStorage.removeItem("exitsJanuary");
  ...
  useEffect(() => {
    ...
    localStorage.setItem("exitsJanuary", JSON.stringify(transactions.exits));
  }, [transactions]);
