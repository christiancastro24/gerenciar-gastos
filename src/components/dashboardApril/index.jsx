...
export const DashboardApril = () => {
  ...
  const [transactions, setTransactions] = useState({
    entries: JSON.parse(localStorage.getItem("entriesApril")) || [],
    exits: JSON.parse(localStorage.getItem("exitsApril")) || [],
  });
  ...
  const resetTransactions = () => {
    ...
    localStorage.removeItem("entriesApril");
    localStorage.removeItem("exitsApril");
    toast.success("All transactions removed!");
    setTimeout(() => window.location.reload(), 1000);
  };

  useEffect(() => {
    localStorage.setItem("entriesApril", JSON.stringify(transactions.entries));
    localStorage.setItem("exitsApril", JSON.stringify(transactions.exits));
  }, [transactions]);
